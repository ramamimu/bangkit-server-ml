...
- example link request
  ...
  ```https
  https://sql-server-oislxufxaa-et.a.run.app/register
  ```
...
- example link request
  ...
  ```https
  https://sql-server-oislxufxaa-et.a.run.app/login
  ```
...
- example link request
  ```https
  https://sql-server-oislxufxaa-et.a.run.app/logout
  ```
- response
...
- example link request
  ...
  ```https
  https://sql-server-oislxufxaa-et.a.run.app/logged
  ```
...
- example link request
  ```https
  https://sql-server-oislxufxaa-et.a.run.app/api/recomendation-place/?key=002
  ```
- parameters
  - key: user_id
- response
...
- example link request
  ...
  ```https
  https://sql-server-oislxufxaa-et.a.run.app/api/detail-place/ChIJHfSeNgNZei4RT3WiyG3HX_U
  ```
